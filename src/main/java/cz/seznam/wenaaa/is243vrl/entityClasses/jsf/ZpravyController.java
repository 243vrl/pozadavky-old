...
import cz.seznam.wenaaa.is243vrl.beans.LoggedBean;
...
import cz.seznam.wenaaa.is243vrl.beans.entityClasses.ZpravyFacade;
...
public class ZpravyController implements Serializable {
    ...
    @EJB
    private cz.seznam.wenaaa.is243vrl.beans.entityClasses.ZpravyFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Bundle").getString("ZpravyCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Bundle").getString("ZpravyUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Bundle").getString("ZpravyDeleted"));
        if (!JsfUtil.isValidationFailed()) {
