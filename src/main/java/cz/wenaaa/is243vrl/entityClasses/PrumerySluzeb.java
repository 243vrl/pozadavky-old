 ...
 * @author vena
 */
public class PrumerySluzeb implements Serializable {
    ...
    public PrumerySluzeb(String letajici, int pocetSluzeb, int pocetVsednichSvatku, double pSv, int pocetSobot,
