...
public class PozadavkyBean implements Serializable {
    ...
    public void ulozPozadavky(String poz) {
        ...
        if (this.konec != this.zacatek) {
            if ((poz.equals("LK")) || (poz.equals("LD")) || (poz.equals("SK")) || (poz.equals("SD"))) {
                return;
            }
        }
        try {
    ...
    public String renderedCellvII(int sloupec, String hodnota, int typ) {
        if ("".equals(hodnota) && typ == 2 && sloupec != 0) {
            return "true";
        }
        if ((!"".equals(hodnota)) && typ == 1 && sloupec != 0) {
            return "true";
        }
        if (sloupec == 0 && typ == 3) {
            return "true";
