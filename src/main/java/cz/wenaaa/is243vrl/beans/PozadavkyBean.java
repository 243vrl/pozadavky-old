...
<<<<<<< HEAD:src/main/java/cz/seznam/wenaaa/is243vrl/beans/PozadavkyBean.java
            gc = pomGC;
=======
           gc = pomGC;
>>>>>>> novyAlgoritmusPlanovani:src/main/java/cz/wenaaa/is243vrl/beans/PozadavkyBean.java
        }
        //System.out.println(new SimpleDateFormat("yy/MMMM/dd").format(gc.getTime()));
        populateColumns();
        nactiPozadavkyNaMesic();
